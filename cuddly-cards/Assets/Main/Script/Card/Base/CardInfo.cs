...
public static class CardInfo
{
    ...
    public enum CardTransition { CHILD, BACK, TOCOVER, FROMCOVER, CLOSE, OPEN, TOINVENTORY, FROMINVENTORY, ENTERINVENTORYPILE, EXITINVENTORYPILE, COLLECTCARD, DISPLAYKEY, RETRACTKEY }
