...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      CURVEDWORLD_TRANSFORM_VERTEX(v.vertex)
				...
				//Advanced Dissolve 
				OUT.texcoord.zw = TRANSFORM_TEX(UnpackUV(v.texcoord1), _MainTex);

				OUT.positionOS = v.vertex;
				OUT.normalOS = v.normal;

				ADVANCED_DISSOLVE_INIT_UV(OUT, v.texcoord, OUT.vertex)
...
//Advanced Dissolve////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	AdvancedDissolveCalculateAlphaAndClip(cutoutSource, color.a, cutout);
